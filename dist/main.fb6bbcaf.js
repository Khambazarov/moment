...
getDateBtn.onclick = function () {
  ...
  getResultSeconds.innerHTML = dayFinder.diff((0, _moment.default)(), "seconds") % 60 === -1 || dayFinder.diff((0, _moment.default)(), "seconds") % 60 === 1 ? "".concat(dayFinder.diff((0, _moment.default)(), "seconds") % 60, " second") : "".concat(dayFinder.diff((0, _moment.default)(), "seconds") % 60, " seconds");
};
